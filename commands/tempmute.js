            ...
            if(message.member.hasPermission('KICK_MEMBERS')){
                ...
                if(args[3] === "d") {
                    ...
                    setTimeout(async () => {
                        ...
                        try {
                            let tempmuteEndEmbed = new Discord.MessageEmbed()
                                .setColor('#DE0C78')
                                ...
                                .setDescription(`<@${usermention.id}> a été demute du serveur ${guildName}.`)
                                .setTimestamp()
                                .setFooter(`${guildName} Server | ${botName} Bot`)
                            message.guild.channels.cache.get(modLogChannel).send(tempmuteEndEmbed)
                        } catch {
